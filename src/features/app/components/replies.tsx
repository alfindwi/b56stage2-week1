...
export function Replies() {
    ...
    return (
        <Flex direction="column" width={"545px"}>
            <Flex>
            <Button leftIcon={<IoIosArrowRoundBack  size={"30px"} />} bg={"transparent"} _active={{color: "white", bg: "none"}} fontWeight={"500"} display={"flex"} justifyContent={"start"} padding={"10px 10px"} color={"white"} mt={"auto"} fontFamily={"Plus Jakarta Sans"} _hover={{textDecoration:"none", bg: "none"}}>
            </Button>
            <Text color={"white"} mt={"3px"} fontSize={"xl"} fontFamily={"Plus Jakarta Sans"} fontWeight={"bold"}>Status</Text>
            </Flex>
        ...
        >
            ...
            <Box ml="10px" width="100%">
                ...
                <Text fontSize="11px" mt={"5px"} fontFamily={"Plus Jakarta Sans"} fontWeight="400" color="gray.500">11:32 PM <Text as={"span"} color="gray.500" ml={"2px"} mr={"2px"}>•</Text>Jul 26, 2023</Text>
        ...
        <Flex padding="5px 20px 5px 20px" width={"545px"} border={"1px solid #545454"} direction="column">
            <Flex align="center">
                <Avatar
                    size="sm"
